...
(() => {
  ...
  class ThreeDStage extends HTMLElement {
    constructor() {
      ...
      // The OBJ/GLB exporters are an authoring affordance — off unless the
      // page asks for them, so an embed shows just the rolodex.
      if (this.hasAttribute('exports')) root.appendChild(this._toolbar);
